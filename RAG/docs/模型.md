...
### [Azure](https://langchain-doc.cn/v1/python/langchain/models.html#azure)
...
### [Google Gemini](https://langchain-doc.cn/v1/python/langchain/models.html#google-gemini)
...
### [AWS Bedrock](https://langchain-doc.cn/v1/python/langchain/models.html#aws-bedrock)
...
绑定用户定义的工具时，模型的响应包括**请求**执行工具。当将模型与[代理](https://langchain-doc.cn/v1/python/langchain/agents)分开使用时，您需要执行请求的操作并将结果返回给模型以用于后续推理。请注意，当使用[代理](https://langchain-doc.cn/v1/python/langchain/agents)时，代理循环将为您处理工具执行循环。
...
### [基础 URL 或代理](https://langchain-doc.cn/v1/python/langchain/models.html#基础-url-或代理)
...
#### [代理配置](https://langchain-doc.cn/v1/python/langchain/models.html#代理配置)
