...
## [响应格式 (Response Format)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#响应格式-response-format)
...
## [提供商策略 (Provider strategy)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#提供商策略-provider-strategy)
...
## [工具调用策略 (Tool calling strategy)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#工具调用策略-tool-calling-strategy)
...
### [自定义工具消息内容 (Custom tool message content)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#自定义工具消息内容-custom-tool-message-content)
...
### [错误处理 (Error handling)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#错误处理-error-handling)

模型在通过工具调用生成结构化输出时可能会出错。LangChain 提供了智能的重试机制来自动处理这些错误。

#### [多个结构化输出错误 (Multiple structured outputs error)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#多个结构化输出错误-multiple-structured-outputs-error)
...
#### [模式验证错误 (Schema validation error)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#模式验证错误-schema-validation-error)
...
#### [错误处理策略 (Error handling strategies)](https://langchain-doc.cn/v1/python/langchain/structured-output.html#错误处理策略-error-handling-strategies)
