...
## [构建基本代理](https://langchain-doc.cn/v1/python/langchain/quickstart.html#构建基本代理)
...
## [构建真实世界的代理](https://langchain-doc.cn/v1/python/langchain/quickstart.html#构建真实世界的代理)
...
### [定义系统提示](https://langchain-doc.cn/v1/python/langchain/quickstart.html#定义系统提示)
...
### [创建工具](https://langchain-doc.cn/v1/python/langchain/quickstart.html#创建工具)

[工具](https://langchain-doc.cn/v1/python/langchain/tools) 允许模型通过调用您定义的函数与外部系统交互。
工具可以依赖于[运行时上下文](https://langchain-doc.cn/v1/python/langchain/runtime)，也可以与[代理记忆](https://langchain-doc.cn/v1/python/langchain/short-term-memory)交互。
...
### [配置模型](https://langchain-doc.cn/v1/python/langchain/quickstart.html#配置模型)

使用适合您用例的[语言模型](https://langchain-doc.cn/v1/python/langchain/models)和[参数](https://langchain-doc.cn/v1/python/langchain/models#parameters)进行设置：
...
### [定义响应格式](https://langchain-doc.cn/v1/python/langchain/quickstart.html#定义响应格式)
...
### [添加记忆](https://langchain-doc.cn/v1/python/langchain/quickstart.html#添加记忆)

向代理添加[记忆](https://langchain-doc.cn/v1/python/langchain/short-term-memory)，以在多次交互中保持状态。这允许代理记住之前的对话和上下文。
...
### [创建并运行代理](https://langchain-doc.cn/v1/python/langchain/quickstart.html#创建并运行代理)
