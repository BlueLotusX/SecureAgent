- > LangChain 的存在，是为了成为构建 LLM 应用最容易的地方，同时具备灵活性并可投入生产环境。
  ...
  ### [1. 我们希望让开发者能够使用最好的模型](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_1-我们希望让开发者能够使用最好的模型)

  不同的提供商暴露不同的 API、不同的模型参数和不同的消息格式。
  标准化这些模型的输入和输出是核心重点，使开发者能够轻松切换到最新、最先进的模型，避免被锁定。

  ### [2. 我们希望让使用模型来编排更复杂的流程变得容易，这些流程会与其他数据和计算交互](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2-我们希望让使用模型来编排更复杂的流程变得容易-这些流程会与其他数据和计算交互)
  ...
  ### [**2022-10-24 — v0.0.1**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2022-10-24-—-v0-0-1)
  ...
  ### [**2022-12**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2022-12)
  ...
  ### [**2023-01**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2023-01)
  ...
  ### [**2023-01**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2023-01-1)

  LangChain 发布 JavaScript 版本。

  LLM 和 Agent 将改变应用程序的构建方式，而 JavaScript 是应用开发者的主要语言。

  ### [**2023-02**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2023-02)
  ...
  **LangChain Inc. 作为公司成立**，以开源 LangChain 项目为基础。
  ...
  ### [**2023-03**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2023-03)
  ...
  ### [**2023-06**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2023-06)
  ...
  **LangSmith 发布**，由 LangChain Inc. 推出，为闭源平台，提供可观测性和评估工具。
  ...
  ### [**2024-01 — v0.1.0**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2024-01-—-v0-1-0)

  **LangChain 发布 0.1.0**，首次脱离 0.0.x 版本。

  随着行业从原型阶段迈向生产阶段，LangChain 提高了对稳定性的关注。

  ### [**2024-02**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2024-02)
  ...
  **LangGraph 发布**，作为开源库。
  ...
  ### [**2024-06**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2024-06)

  **LangChain 拥有超过 700 个集成。**

  集成从 LangChain 核心包中拆分，要么迁移至独立包（核心集成），要么迁移至 `langchain-community`。

  ### [**2024-10**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2024-10)
  ...
  ### [**2025-04**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2025-04)
  ...
  ### [**2025-10-20 — v1.0.0**](https://langchain-doc.cn/v1/python/langchain/philosophy.html#_2025-10-20-—-v1-0-0)
