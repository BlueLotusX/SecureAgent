...
![core_agent_loop.png](https://langchain-doc.cn/img/langchain-5e9cc07a/core_agent_loop.png)core_agent_loop.png

中间件在这些步骤的**之前**和**之后**暴露了钩子 (hooks)：

![middleware_final.png](https://langchain-doc.cn/img/langchain-5e9cc07a/middleware_final.png)middleware_final.png
...
### [缓存 (Anthropic prompt caching)](https://langchain-doc.cn/v1/python/langchain/middleware.html#缓存-anthropic-prompt-caching)
...
### [限制模型调用 (Model call limit)](https://langchain-doc.cn/v1/python/langchain/middleware.html#限制模型调用-model-call-limit)
...
### [限制工具调用 (Tool call limit)](https://langchain-doc.cn/v1/python/langchain/middleware.html#限制工具调用-tool-call-limit)
...
### [模型回退 (Model fallback)](https://langchain-doc.cn/v1/python/langchain/middleware.html#模型回退-model-fallback)
...
### [PII 检测 (PII detection)](https://langchain-doc.cn/v1/python/langchain/middleware.html#pii-检测-pii-detection)
...
### [规划 (Planning)](https://langchain-doc.cn/v1/python/langchain/middleware.html#规划-planning)
...
### [LLM 工具选择器 (LLM tool selector)](https://langchain-doc.cn/v1/python/langchain/middleware.html#llm-工具选择器-llm-tool-selector)
...
### [工具重试 (Tool retry)](https://langchain-doc.cn/v1/python/langchain/middleware.html#工具重试-tool-retry)
...
### [LLM 工具模拟器 (LLM tool emulator)](https://langchain-doc.cn/v1/python/langchain/middleware.html#llm-工具模拟器-llm-tool-emulator)
...
### [上下文编辑 (Context editing)](https://langchain-doc.cn/v1/python/langchain/middleware.html#上下文编辑-context-editing)
...
## [自定义中间件 (Custom middleware)](https://langchain-doc.cn/v1/python/langchain/middleware.html#自定义中间件-custom-middleware)
...
### [基于装饰器的中间件](https://langchain-doc.cn/v1/python/langchain/middleware.html#基于装饰器的中间件)
...
#### [可用装饰器](https://langchain-doc.cn/v1/python/langchain/middleware.html#可用装饰器)
...
#### [何时使用装饰器](https://langchain-doc.cn/v1/python/langchain/middleware.html#何时使用装饰器)
...
### [基于类的中间件](https://langchain-doc.cn/v1/python/langchain/middleware.html#基于类的中间件)

#### [两种钩子样式](https://langchain-doc.cn/v1/python/langchain/middleware.html#两种钩子样式)
...
#### [节点式钩子 (Node-style hooks)](https://langchain-doc.cn/v1/python/langchain/middleware.html#节点式钩子-node-style-hooks)
...
#### [包装式钩子 (Wrap-style hooks)](https://langchain-doc.cn/v1/python/langchain/middleware.html#包装式钩子-wrap-style-hooks)
